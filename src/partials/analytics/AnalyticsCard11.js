          ...
          <table className="table-auto w-full">
            ...
            <tbody className="text-sm divide-y divide-gray-100">
              ...
              <tr>
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    <svg className="w-4 h-4 fill-current text-gray-400 shrink-0 mr-2" viewBox="0 0 16 16">
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="text-left font-medium text-green-500">$12,499.77</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    <div className="shrink-0 rounded-full mr-2 sm:mr-3 bg-green-500">
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="text-left font-medium text-green-500">$4,227.09</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    ...
                    <div className="font-medium text-gray-800">2021 Web Bootcamp</div>
                  </div>
                </td>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex shrink-0 -space-x-3 -ml-px">
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="text-left font-medium text-green-500">$2,499.77</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    <div className="shrink-0 rounded-full mr-2 sm:mr-3 bg-light-blue-500">
                      <svg className="w-9 h-9 fill-current text-indigo-50" viewBox="0 0 36 36">
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="text-left font-medium text-green-500">$2,224.09</div>
                </td>
              </tr>
              {/* Row */}
              <tr>
                <td className="p-2 whitespace-nowrap">
                  <div className="flex items-center">
                    <div className="shrink-0 rounded-full mr-2 sm:mr-3 bg-red-500">
                      <svg className="w-9 h-9 fill-current text-indigo-50" viewBox="0 0 36 36">
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="text-left font-medium text-green-500">$1,949.72</div>
                </td>
              </tr>
            </tbody>
          </table>
