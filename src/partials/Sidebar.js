          ...
          <div>
            ...
            <ul className="mt-3">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('analytics') && 'bg-gray-900'}`}>
                <NavLink exact to="/analytics" className={`block text-gray-200 hover:text-white truncate transition duration-150 ${pathname.includes('analytics') && 'hover:text-gray-200'}`}>
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/ecommerce/customers" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/ecommerce/orders" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Orders</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/ecommerce/invoices" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/ecommerce/shop" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Shop</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/ecommerce/shop-2" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Shop 2</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/ecommerce/product" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/ecommerce/cart" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Cart</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/ecommerce/cart-2" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Cart 2</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/ecommerce/pay" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('campaigns') && 'bg-gray-900'}`}>
                <NavLink exact to="/campaigns" className={`block text-gray-200 hover:text-white truncate transition duration-150 ${pathname.includes('campaigns') && 'hover:text-gray-200'}`}>
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                  ...
                  return (
                    <React.Fragment>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/team/team-tabs" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/team/team-tiles" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/team/profile" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('messages') && 'bg-gray-900'}`}>
                <NavLink exact to="/messages" className={`block text-gray-200 hover:text-white truncate transition duration-150 ${pathname.includes('messages') && 'hover:text-gray-200'}`}>
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('tasks') && 'bg-gray-900'}`}>
                <NavLink exact to="/tasks" className={`block text-gray-200 hover:text-white truncate transition duration-150 ${pathname.includes('tasks') && 'hover:text-gray-200'}`}>
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('inbox') && 'bg-gray-900'}`}>
                <NavLink exact to="/inbox" className={`block text-gray-200 hover:text-white truncate transition duration-150 ${pathname.includes('inbox') && 'hover:text-gray-200'}`}>
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('calendar') && 'bg-gray-900'}`}>
                <NavLink exact to="/calendar" className={`block text-gray-200 hover:text-white truncate transition duration-150 ${pathname.includes('calendar') && 'hover:text-gray-200'}`}>
                  <div className="flex items-center">
                    <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                  ...
                  return (
                    <React.Fragment>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/settings/account" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/settings/notifications" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/settings/apps" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/settings/plans" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Plans</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/settings/billing" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/settings/feedback" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                  ...
                  return (
                    <React.Fragment>
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/utility/changelog" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/utility/roadmap" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/utility/faqs" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">FAQs</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/utility/empty-state" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/utility/404" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
            ...
            <ul className="mt-3">
              ...
              <SidebarLinkGroup>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a href="#0" className={`block text-gray-200 hover:text-white truncate transition duration-150 ${open && 'hover:text-gray-200'}`} onClick={(e) => { e.preventDefault(); sidebarExpanded ? handleClick() : setSidebarExpanded(true) }}>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <path className="fill-current text-gray-600" d="M8.07 16H10V8H8.07a8 8 0 110 8z" />
                              <path className="fill-current text-gray-400" d="M15 12L8 6v5H0v2h8v5z" />
                            </svg>
                            <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Authentication</span>
                          </div>
                          {/* Icon */}
                          <div className="flex shrink-0 ml-2">
                            <svg className={`w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 ${open && 'transform rotate-180'}`} viewBox="0 0 12 12">
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/signin" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Sign in</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/signup" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Sign up</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/reset-password" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Reset Password</span>
                            </NavLink>
                          </li>
                        </ul>
                      </div>
                    ...
                    <React.Fragment>
                      <a href="#0" className={`block text-gray-200 hover:text-white truncate transition duration-150 ${open && 'hover:text-gray-200'}`} onClick={(e) => { e.preventDefault(); sidebarExpanded ? handleClick() : setSidebarExpanded(true) }}>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <path className="fill-current text-gray-600" d="M19 5h1v14h-2V7.414L5.707 19.707 5 19H4V5h2v11.586L18.293 4.293 19 5Z" />
                              <path className="fill-current text-gray-400" d="M5 9a4 4 0 1 1 0-8 4 4 0 0 1 0 8Zm14 0a4 4 0 1 1 0-8 4 4 0 0 1 0 8ZM5 23a4 4 0 1 1 0-8 4 4 0 0 1 0 8Zm14 0a4 4 0 1 1 0-8 4 4 0 0 1 0 8Z" />
                            </svg>
                            <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Onboarding</span>
                          </div>
                          {/* Icon */}
                          <div className="flex shrink-0 ml-2">
                            <svg className={`w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 ${open && 'transform rotate-180'}`} viewBox="0 0 12 12">
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/onboarding-01" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Step 1</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/onboarding-02" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Step 2</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/onboarding-03" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Step 3</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/onboarding-04" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate">
              ...
              <SidebarLinkGroup activecondition={pathname.includes('component')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <a href="#0" className={`block text-gray-200 hover:text-white truncate transition duration-150 ${pathname.includes('component') && 'hover:text-gray-200'}`} onClick={(e) => { e.preventDefault(); sidebarExpanded ? handleClick() : setSidebarExpanded(true) }}>
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <circle className={`fill-current text-gray-600 ${pathname.includes('component') && 'text-indigo-500'}`} cx="16" cy="8" r="8" />
                              <circle className={`fill-current text-gray-400 ${pathname.includes('component') && 'text-indigo-300'}`} cx="8" cy="16" r="8" />
                            </svg>
                            <span className="text-sm font-medium ml-3 lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Components</span>
                          </div>
                          {/* Icon */}
                          <div className="flex shrink-0 ml-2">
                            <svg className={`w-3 h-3 shrink-0 ml-1 fill-current text-gray-400 ${open && 'transform rotate-180'}`} viewBox="0 0 12 12">
                      ...
                      <div className="lg:hidden lg:sidebar-expanded:block 2xl:block">
                        <ul className={`pl-9 mt-1 ${!open && 'hidden'}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/component/button" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Button</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/component/form" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Input Form</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/component/dropdown" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Dropdown</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/component/alert" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Alert & Banner</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/component/modal" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Modal</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/component/pagination" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Pagination</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/component/tabs" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Tabs</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/component/breadcrumb" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Breadcrumb</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/component/badge" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Badge</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/component/avatar" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Avatar</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/component/tooltip" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Tooltip</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/component/accordion" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Accordion</span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink exact to="/component/icons" className="block text-gray-400 hover:text-gray-200 transition duration-150 truncate" activeClassName="!text-indigo-500">
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Icons</span>
                            </NavLink>
                          </li>
                        </ul>
                      </div>
