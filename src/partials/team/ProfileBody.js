      ...
      <div className="relative px-4 sm:px-6 pb-8">
        ...
        <header className="text-center sm:text-left mb-6">
          ...
          <div className="inline-flex items-start mb-2">
            <h1 className="text-2xl text-gray-800 font-bold">Carolyn McNeail</h1>
          ...
          <div className="flex flex-wrap justify-center sm:justify-start space-x-4">
            <div className="flex items-center">
              <svg className="w-4 h-4 fill-current shrink-0 text-gray-400" viewBox="0 0 16 16">
                <path d="M8 8.992a2 2 0 1 1-.002-3.998A2 2 0 0 1 8 8.992Zm-.7 6.694c-.1-.1-4.2-3.696-4.2-3.796C1.7 10.69 1 8.892 1 6.994 1 3.097 4.1 0 8 0s7 3.097 7 6.994c0 1.898-.7 3.697-2.1 4.996-.1.1-4.1 3.696-4.2 3.796-.4.3-1 .3-1.4-.1Zm-2.7-4.995L8 13.688l3.4-2.997c1-1 1.6-2.198 1.6-3.597 0-2.798-2.2-4.996-5-4.996S3 4.196 3 6.994c0 1.399.6 2.698 1.6 3.697 0-.1 0-.1 0 0Z" />
              </svg>
              <span className="text-sm font-medium whitespace-nowrap text-gray-500 ml-2">Milan, IT</span>
            </div>
            <div className="flex items-center">
              <svg className="w-4 h-4 fill-current shrink-0 text-gray-400" viewBox="0 0 16 16">
        ...
        <div className="relative mb-6">
          ...
          <ul className="relative text-sm font-medium flex flex-nowrap -mx-4 sm:-mx-6 lg:-mx-8 overflow-x-scroll no-scrollbar">
            ...
            <li className="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
              <a className="block pb-3 text-gray-500 hover:text-gray-600 whitespace-nowrap" href="#0">Connections</a>
            </li>
            <li className="mr-6 last:mr-0 first:pl-4 sm:first:pl-6 lg:first:pl-8 last:pr-4 sm:last:pr-6 lg:last:pr-8">
              <a className="block pb-3 text-gray-500 hover:text-gray-600 whitespace-nowrap" href="#0">Contributions</a>
            </li>
          </ul>
        </div>
              ...
              <div className="grid xl:grid-cols-2 gap-4">
                ...
                <div className="bg-white p-4 border border-gray-200 rounded-sm shadow-sm">
                  ...
                  <div className="grow flex items-center truncate mb-2">
                    ...
                    <div className="truncate">
                      <span className="text-sm font-medium text-gray-800">Acme Marketing</span>
                    </div>
                  </div>
                  {/* Card content */}
                ...
                <div className="bg-white p-4 border border-gray-200 rounded-sm shadow-sm">
                  ...
                  <div className="grow flex items-center truncate mb-2">
                    ...
                    <div className="truncate">
                      <span className="text-sm font-medium text-gray-800">Acme Product</span>
                    </div>
                  </div>
                  {/* Card content */}
                  <div className="text-sm mb-3">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore.</div>
                ...
                <ul className="space-y-3">
                  ...
                  <li className="sm:flex sm:items-center sm:justify-between">
                    <div className="sm:grow flex items-center text-sm">
                      ...
                      {/* Position */}
                      <div>
                        <div className="font-medium text-gray-800">Senior Product Designer</div>
                    ...
                    <div className="sm:ml-2 mt-2 sm:mt-0">
                      <ul className="flex flex-wrap sm:justify-end -m-1">
                        <li className="m-1">
                          <button className="inline-flex items-center justify-center text-xs font-medium leading-5 rounded-full px-2.5 py-0.5 border border-gray-200 hover:border-gray-300 shadow-sm bg-white text-gray-500 duration-150 ease-in-out">Marketing</button>
                        </li>
                        <li className="m-1">
                          <button className="inline-flex items-center justify-center text-xs font-medium leading-5 rounded-full px-2.5 py-0.5 border border-gray-200 hover:border-gray-300 shadow-sm bg-white text-gray-500 duration-150 ease-in-out">+4</button>
                        </li>
                      </ul>
                    </div>
                  </li>
                  ...
                  <li className="sm:flex sm:items-center sm:justify-between">
                    <div className="sm:grow flex items-center text-sm">
                      ...
                      {/* Position */}
                      <div>
                        <div className="font-medium text-gray-800">Product Designer</div>
                        <div className="flex flex-nowrap items-center space-x-2 whitespace-nowrap">
                          <div>Milan, IT</div>
                          <div className="text-gray-400">·</div>
